  ...
  return (
    <main id="main" className="min-h-screen flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-2xl" role="alert" aria-live="assertive">
        <div
          className="font-pixel text-[14px] sm:text-[18px] tracking-widest text-glow-amber mb-6"
          aria-hidden="true"
        >
          ░ ░ ░ SYSTEM FAULT ░ ░ ░
        </div>

        <h1 className="font-display text-[64px] sm:text-[96px] leading-none text-glow-magenta mb-3">
          Crash.
        </h1>
