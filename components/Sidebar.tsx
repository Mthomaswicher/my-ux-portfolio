...
const NAV = [
  ...
  { no: "02", label: "JOURNEY", basicLabel: "Experience", href: "/experience" },
  { no: "03", label: "ABOUT", basicLabel: "About", href: "/about" },
  { no: "04", label: "LAB", basicLabel: "Lab", href: "/lab" },
  { no: "05", label: "GUESTBOOK", basicLabel: "Guestbook", href: "/guestbook" },
];
...
export default function Sidebar() {
  ...
  return (
    <>
      <button
        type="button"
        className="sidebar-menu-btn md:hidden fixed top-[max(0.75rem,env(safe-area-inset-top))] right-3 z-50 px-4 py-2.5 min-h-[44px] min-w-[44px] bg-bg-deep/95 backdrop-blur-sm font-pixel text-[10px] tracking-widest text-glow-cyan border border-neon-cyan/70 shadow-neon-cyan"
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
      ...
      >
        <ModeText
          scenic={open ? "× CLOSE" : "▦ MENU"}
          basic={open ? "Close" : "Menu"}
        />
      </button>
      ...
      >
        <div className="flex flex-col gap-6 p-5 pt-[max(1.5rem,env(safe-area-inset-top))] pb-[max(1.5rem,env(safe-area-inset-bottom))] min-h-[100dvh]">
          ...
          >
            <div className="sidebar-avatar relative w-12 h-12 cartridge p-0.5 overflow-hidden">
              <Image
                src="/headshot.jpg"
                alt=""
                width={48}
          ...
          <nav aria-labelledby="explore-heading">
            ...
            >
              <ModeText scenic="EXPLORE" basic="Menu" />
            </div>
          ...
          <nav aria-labelledby="contact-heading">
            ...
            >
              <ModeText scenic="FIND ME AT" basic="Contact" />
            </div>
          ...
          <div className="mt-auto pt-6">
            <Link
              href="/?restart=1"
              className="sidebar-restart inline-flex items-center min-h-[44px] py-2 font-pixel text-[9px] tracking-widest text-ink-mute hover:text-glow-magenta"
              onClick={() => setOpen(false)}
            >
              <span aria-hidden="true">↩&nbsp;</span>
              <ModeText scenic="INSERT COIN" basic="Restart intro" />
            </Link>
          </div>
        </div>
      </aside>
